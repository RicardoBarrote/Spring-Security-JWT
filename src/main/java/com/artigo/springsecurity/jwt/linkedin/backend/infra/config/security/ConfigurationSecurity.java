        ...
        return security.csrf(
                ...
                .authorizeHttpRequests(a ->
                        a.requestMatchers("/",
                                ...
                                .requestMatchers(HttpMethod.GET, "/lojistas").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET, "/lojistas/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/lojistas").hasRole("LOJISTA")
                                .requestMatchers(HttpMethod.DELETE, "/lojistas/{id}").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.POST, "/administradores").permitAll()
                                .requestMatchers(HttpMethod.GET, "/administradores").permitAll()
                                .requestMatchers(HttpMethod.GET, "/administradores/{id}").permitAll()
                                .requestMatchers(HttpMethod.PUT, "/administradores").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/administradores/{id}").permitAll()
